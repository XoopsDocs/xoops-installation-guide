...
| xef9\_groups\_users\_link | received 2 entries. This means the one user created in step 9/14 \(Figure 16\)  belongs to both the webmaster and registered users groups. |
